/* udpex2.c: Minh họa gửi quảng bá trên giao thức UDP */
...
int main() {
    ...
    /* Cho phép gửi quảng bá trên socket này.
     * Mặc định socket không cho phép gửi quảng bá. */
    ...
    toaddr.sin_addr.s_addr = inet_addr("172.22.80.255"); // Địa chỉ quảng bá cho mạng này
